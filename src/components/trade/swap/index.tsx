...
const QuickTrade = (props: QuickTradeProps) => {
  ...
  useEffect(() => {
    ...
    const navData: TradeInfoItem = {
      ...
      tooltip:
        'Net Asset Value (NAV) for an Crypto Oracles DAO token is the net value of the underlying tokens minus the value of the debt taken on (only applicable for leveraged tokens). Sometimes the price of a token will trade at a different value than its NAV',
    }
    const navIndex = 2
